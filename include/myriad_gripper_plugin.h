//*****************************************************************************
//
// File Name	: 'myriad_gripper_plugin.h'
// Author	: Steve NGUYEN
...
#if !defined(MYRIAD_GRIPPER_PLUGIN_H)
#define MYRIAD_GRIPPER_PLUGIN_H
...
/// @{
/** \defgroup GazeboRosMyriadGripper Plugin XML Reference and Example
    ...
    <gazebo>
    <plugin name="gazebo_ros_myriad_gripper" filename="libgazebo_ros_myriad_gripper.so">
    <robotNamespace>/robot/left_myriad_gripper</robotNamespace>
...
class GazeboRosMyriadGripper : public ModelPlugin
{
  /// \brief Constructor
public: GazeboRosMyriadGripper();

  /// \brief Destructor
public: virtual ~GazeboRosMyriadGripper();
